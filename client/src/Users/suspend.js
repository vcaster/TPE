...
class EditUser extends Component {
    ...
    success = () => {
        if (this.state.formSuccess){
            MySwal.fire({
                icon: 'success',
                title: 'Staff Successfully Suspended, You will be redirected shortly.'
              })
        }
    ...
    submitForm = (event) => {
        ...
        if(formIsValid){
            ...
            this.props.dispatch(updateUser(dataToSubmit)).then(response =>{
                this.props.dispatch(adLog(this.props.user.userData._id,"Suspended a staff",dataToSubmit,"/view_user/"+dataToSubmit._id,'suspend')).then(response =>{
    ...
    componentDidMount() {
        ...
        this.props.dispatch(getUserId(id)).then(response=>{
            ...
            const newFormdata  = populateFields(this.state.formdata,this.props.user.form, 'userS');
            ...
            <section className="content">
                <div className="container-fluid">
                    <div className="row">
                        ...
                        <p className="login-box-msg">Suspend {title}</p>
                        ...
                        :null}
                            ...
                            <div className="row">
                                ...
                                <div className="col-4">
                                    <button className="btn btn-block bg-gradient-warning" type="button" onClick={(event)=> this.submitForm(event)}>
                                    Suspend {title}
                                </button>
                                </div>
