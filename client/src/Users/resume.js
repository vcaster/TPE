...
class ResumeUser extends Component {
    ...
    success = () => {
        if (this.state.formSuccess){
            MySwal.fire({
                icon: 'success',
                title: 'Staff Resumed Successfully, You will be redirected shortly.'
              })
        }
    ...
    submitForm = (event) => {
        ...
        if(formIsValid){
            ...
            this.props.dispatch(updateUser(dataToSubmit)).then(response =>{
                this.props.dispatch(adLog(this.props.user.userData._id,"Granted a staff access",dataToSubmit,"/view_user/"+dataToSubmit._id,'resume')).then(response =>{
    ...
    componentDidMount() {
        ...
        this.props.dispatch(getUserId(id)).then(response=>{
            ...
            const newFormdata  = populateFields(this.state.formdata,this.props.user.form, 'userR');
            ...
            <section className="content">
                <div className="container-fluid">
                    <div className="row">
                        ...
                        <p className="login-box-msg">Resume {title}</p>
                        ...
                        :null}
                            ...
                            <div className="row">
                                ...
                                <div className="col-4">
                                    <button className="btn btn-block bg-gradient-success" type="button" onClick={(event)=> this.submitForm(event)}>
                                    Resume {title}
                                </button>
                                </div>
...
export default connect(mapStateToProps)(ResumeUser);