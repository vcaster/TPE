...
class DeleteFireSafety extends Component {
    ...
    success = () => {
        if (this.state.formSuccess){
            MySwal.fire({
                icon: 'success',
                title: 'Deleted Fire Safety successfully, You will be redirected shortly.'
              })
        }
    ...
    submitForm = (event) => {
        ...
        if(formIsValid){
            ...
            this.props.dispatch(updateFireSafety(dataToSubmit)).then(response =>{
                this.props.dispatch(adLog(this.props.user.userData._id,"Deleted Fire Safety",dataToSubmit,"/fire_safety_view/"+dataToSubmit._id,'delete')).then(response =>{
...
export default connect(mapStateToProps)(DeleteFireSafety);