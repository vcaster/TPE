...
import { getAddr, getFireSafetyToForm } from '../../actions/form_actions';
...
class FireSafety extends Component {    
    ...
    componentDidMount() {
        ...
        this.props.dispatch(getFireSafetyToForm(
            this.state.skip,
            this.state.limit,
            this.state.filters
        )).then(response => {
...
export default connect(mapStateToProps)(FireSafety);