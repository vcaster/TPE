...
class DeleteChangeShift extends Component {
    ...
    success = () => {
        if (this.state.formSuccess){
            MySwal.fire({
                icon: 'success',
                title: 'Deleted Change of Shift successfully, You will be redirected shortly.'
              })
        }
        ...
        if(formIsValid){
            ...
            this.props.dispatch(updateChangeShift(dataToSubmit)).then(response =>{
                if(response.payload.success){
                    this.props.dispatch(adLog(this.props.user.userData._id,"Deleted Change of Shift",dataToSubmit,"/change_shift_view/"+dataToSubmit._id,'edit')).then(response =>{});
                    this.setState({
                        formError: false,
                        formSuccess: true
                    });
...
export default connect(mapStateToProps)(DeleteChangeShift);