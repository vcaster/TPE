...
import { getAddr, clearForm, adChangeShift, adLog} from '../../actions/form_actions';
...
class AddChangeShift extends Component {
    ...
    state = {
        ...
        formdata:{
            ...
            parked: {
                ...
                value: '',
                config: {
                    label: 'Vehicle parked in assigned location, Key & Log book in Unit',
                    name: 'parked',
                    options: [
                        {key: 'Yes',value: 'Yes'},
                        {key: 'N/A', value: 'N/A'},
    ...
    success = () => {
        if (this.state.formSuccess){
            MySwal.fire({
                icon: 'success',
                title: 'Added Change of shift successfully, You will be redirected shortly.'
              })
        }
    ...
    submitForm = (event) => {
        ...
        if(formIsValid){
            console.log(dataToSubmit);
            this.props.dispatch(adChangeShift(dataToSubmit)).then(response =>{
                if(response.payload.success){
                    this.props.dispatch(adLog(this.props.user.userData._id,"Added Change of Shift",dataToSubmit,"/forms/change_shift",'add')).then(response =>{});
                    this.setState({
                        formError: false,
                        formSuccess: true
                    });
...
export default connect(mapStateToProps)(AddChangeShift);