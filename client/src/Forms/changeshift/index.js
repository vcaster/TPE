...
import { getAddr, getChangeShiftToForm } from '../../actions/form_actions';
...
class ChangeShift extends Component {    
    ...
    componentDidMount() {
        ...
        this.props.dispatch(getChangeShiftToForm(
            this.state.skip,
            this.state.limit,
            this.state.filters
        )).then(response => {
                        ...
                        <div className="card card-primary">
                            ...
                            <div className="card">
                                <div className="card-header">
                                    ...
                                    type="default"
                                    title="View"
                                    linkTo="/forms/change_shift_view"
...
export default connect(mapStateToProps)(ChangeShift);