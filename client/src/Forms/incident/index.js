...
import { getIndiv, getUsrs, getAddr, getIncidentToForm } from '../../actions/form_actions';
import Retrive from '../../components/utils/retrive'

const title = "Standard Incident Report Form";
...
class Incident extends Component {    
    ...
    componentDidMount() {
        this.props.dispatch(getIncidentToForm(
            this.state.skip,
            this.state.limit,
            this.state.filters
        )).then(response => {
