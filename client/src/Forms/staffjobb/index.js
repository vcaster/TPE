...
import { getAddr, getStaffDecBToForm } from '../../actions/form_actions';
import Retrive from '../../components/utils/retrive'

const title = "Staff Job Description 3pm - 11pm";

class StaffDescB extends Component {    
    ...
    componentDidMount() {
        ...
        this.props.dispatch(getStaffDecBToForm(
            this.state.skip,
            this.state.limit,
            this.state.filters
        )).then(response => {
                        ...
                        <div className="card card-primary">
                            ...
                            <div className="card">
                                <div className="card-header">
                                    ...
                                    type="default"
                                    title="View"
                                    linkTo="/forms/staff_desc_b_view"
...
export default connect(mapStateToProps)(StaffDescB);