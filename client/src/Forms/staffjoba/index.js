...
import { getAddr, getStaffDecAToForm } from '../../actions/form_actions';
import Retrive from '../../components/utils/retrive'

const title = "Staff Job Description 11pm - 9am";

class StaffDescA extends Component {    
    ...
    componentDidMount() {
        ...
        this.props.dispatch(getStaffDecAToForm(
            this.state.skip,
            this.state.limit,
            this.state.filters
        )).then(response => {
                        ...
                        <div className="card card-primary">
                            ...
                            <div className="card">
                                <div className="card-header">
                                    ...
                                    type="default"
                                    title="View"
                                    linkTo="/forms/staff_desc_a_view"
...
export default connect(mapStateToProps)(StaffDescA);