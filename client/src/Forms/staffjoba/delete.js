...
class DeleteStaffDescA extends Component {
    ...
    success = () => {
        if (this.state.formSuccess){
            MySwal.fire({
                icon: 'success',
                title: 'Deleted Staff Job Description 11pm - 9am successfully, You will be redirected shortly.'
              })
        }
...
export default connect(mapStateToProps)(DeleteStaffDescA);