...
class DeleteHouseMeeting extends Component {
    ...
    submitForm = (event) => {
        ...
        if(formIsValid){
            ...
            this.props.dispatch(updateHouseMeeting(dataToSubmit)).then(response =>{
                this.props.dispatch(adLog(this.props.user.userData._id,"Deleted House Meeting",dataToSubmit,"/house_meeting_view/"+dataToSubmit._id,'delete')).then(response =>{
...
export default connect(mapStateToProps)(DeleteHouseMeeting);