...
import { getAddr, getHouseMeetingToForm } from '../../actions/form_actions';
import Retrive from '../../components/utils/retrive'

const title = "House Meeting";

class HouseMeeting extends Component {    
    ...
    componentDidMount() {
        ...
        this.props.dispatch(getHouseMeetingToForm(
            this.state.skip,
            this.state.limit,
            this.state.filters
        )).then(response => {
...
export default connect(mapStateToProps)(HouseMeeting);