...
import { getAddr, getIndiv, clearForm, updateAttendance, getAttendanceId, adLog } from '../../actions/form_actions';
...
class DeleteAttend extends Component {
    ...
    success = () => {
        if (this.state.formSuccess){
            MySwal.fire({
                icon: 'success',
                title: 'Deleted Individual Attendance successfully, You will be redirected shortly.'
              })
        }
    ...
    submitForm = (event) => {
        ...
        if(formIsValid){
            ...
            this.props.dispatch(updateAttendance(dataToSubmit)).then(response =>{
                if(response.payload.success){
                    this.props.dispatch(adLog(this.props.user.userData._id,"Deleted Individual Attendance",dataToSubmit,"/attendance_view/"+dataToSubmit._id,'delete')).then(response =>{});
                    this.setState({
                        formError: false,
                        formSuccess: true
                    });
    ...
    componentDidMount() {
        ...
        // console.log(id)
        this.props.dispatch(getAttendanceId(id)).then(response=>{
            // if(!this.props.form.Dailyprognoteid){
                //console.log(id+"product found ")
            //     this.props.history.push('/')
            // }
            console.log(this.props.form.form);
            const newFormdata  = populateFields(this.state.formdata,this.props.form.form, 'attend');
            this.setState({
            formdata: newFormdata,
            loading: false           
                })
            ...
            <section className="content">
                <div className="container-fluid">
                    <div className="row">
                        ...
                        <strong>P = Present | E = Elopment | H = Hospitalized (explain in comment) | O = Others (explain in comment) | F = Family home visit</strong>
...
export default connect(mapStateToProps)(DeleteAttend);