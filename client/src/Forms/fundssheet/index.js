...
class FundSheet extends Component {    
    ...
    componentDidMount() {
        ...
        this.props.dispatch(getFundsSheetToForm(
            this.state.skip,
            this.state.limit,
            this.state.filters
        )).then(response => {
...
export default connect(mapStateToProps)(FundSheet);