    ...
    submitForm = (event) => {
        ...
        if(formIsValid){
            ...
            this.props.dispatch(updateSafetyInspec(dataToSubmit)).then(response =>{
                this.props.dispatch(adLog(this.props.user.userData._id,"Modified Safety Inspection",dataToSubmit,"/safety_inspection_view/"+dataToSubmit._id,'edit')).then(response =>{
