        ...
        if(formIsValid){
            ...
            this.props.dispatch(updateDailyProgNote(dataToSubmit)).then(response =>{
                if(response.payload.success){
                    this.props.dispatch(adLog(this.props.user.userData._id,"Modified Daily Progress Note",dataToSubmit,"/daily_progress_note_view/"+dataToSubmit._id,'edit')).then(response =>{});
                    this.setState({
                        formError: false,
                        formSuccess: true
                    });
