...
import { getIndiv, clearForm, updateDailyProgNote, getDailyProgNoteId, adLog } from '../../actions/form_actions';
...
class DeleteDailyprognote extends Component {
    ...
    submitForm = (event) => {
        ...
        if(formIsValid){
            ...
            this.props.dispatch(updateDailyProgNote(dataToSubmit)).then(response =>{
                if(response.payload.success){
                    this.props.dispatch(adLog(this.props.user.userData._id,"Deleted Daily Progess Note",dataToSubmit,"/daily_progress_note_view/"+dataToSubmit._id,'delete')).then(response =>{});
                    this.setState({
                        formError: false,
                        formSuccess: true
                    });
    ...
    componentDidMount() {
        ...
        this.props.dispatch(getDailyProgNoteId(id)).then(response=>{
            ...
            const newFormdata  = populateFields(this.state.formdata,this.props.form.form, 'Daily_prog_note');
            this.setState({
            formdata: newFormdata,
            loading:false
                })
...
export default connect(mapStateToProps)(DeleteDailyprognote);