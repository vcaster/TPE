...
class EditStatement extends Component {
    ...
    success = () => {
        if (this.state.formSuccess){
            MySwal.fire({
                icon: 'success',
                title: 'Edited Employee Statement successfully, You will be redirected shortly.'
              })
        }
    ...
    submitForm = (event) => {
        ...
        if(formIsValid){
            ...
            this.props.dispatch(updateStatement(dataToSubmit)).then(response =>{
                this.props.dispatch(adLog(this.props.user.userData._id,"Edited Employee Statement",dataToSubmit,"/statement_view/"+dataToSubmit._id,'edit')).then(response =>{});
