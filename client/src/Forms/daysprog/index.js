...
import { getAddr, getUsrs, getIndiv, getDaysProgToForm } from '../../actions/form_actions';
import Retrive from '../../components/utils/retrive'

const title = "30 Days Progress Note";

class DaysProg extends Component {    
    ...
    componentDidMount() {
        ...
        this.props.dispatch(getDaysProgToForm(
            this.state.skip,
            this.state.limit,
            this.state.filters
        )).then(response => {
...
export default connect(mapStateToProps)(DaysProg);