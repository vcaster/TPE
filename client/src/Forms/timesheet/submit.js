...
class SubmitTimeSheet extends Component {
        ...
        formdata:{
            ...
            sun1di: {
                ...
                config:{
                    name: 'sun1di',
                    type: 'text',
                    placeholder: 'Time In',  disabled:true           
                },
                validation:{
            ...
            sun1do: {
                ...
                config:{
                    name: 'sun1do',
                    type: 'text',
                    placeholder: 'Time Out',    disabled:true         
                },
                validation:{
            ...
            sun1dt: {
                ...
                config:{
                    name: 'sun1dt',
                    type: 'text',
                    placeholder: 'Total Hours',   disabled:true         
                },
                validation:{
            ...
            totalhrs: {
                ...
                config:{
                    ...
                    label: 'Total Hours',disabled:true          
                },
                validation:{
                    required: true
                },
            ...
            staffsignimg: {
                ...
                config:{
                    ...
                    type: 'text',
                    placeholder: 'Signature', disabled:true           
                },
                validation:{
    ...
    success = () => {
        if (this.state.formSuccess){
            MySwal.fire({
                icon: 'success',
                title: 'Submitted Time Sheet successfully, You will be redirected shortly.'
              })
        }
    ...
    submitForm = (event) => {
        ...
        if(formIsValid){
            ...
            this.props.dispatch(updateTimeSheet(dataToSubmit)).then(response =>{
                this.props.dispatch(adLog(this.props.user.userData._id,"Submitted Time Sheet",dataToSubmit,"/time_sheet_view/"+dataToSubmit._id,'submit')).then(response =>{
            ...
            <div className="container-fluid">
                            ...
                            <div className="card">
                                ...
                                :null}
                                    ...
                                    <div className="row">
                                        ...
                                        <div className="col-4">
                                        <button type="button" class="btn btn-block bg-gradient-success" data-toggle="modal" data-target="#modal-default">
                                        Submit {title}
                                        </button>
                ...
                <div className="modal-dialog">
                    ...
                    <div className="modal-body">
                        <p>Can you see your signature?</p>
                        <strong>If you can't see your signature, submit and fill another with your signature</strong>
                    </div>
                    <div className="modal-footer justify-content-between">
                        <button type="button" className="btn btn-default" onClick={(event)=> this.submitForm(event)} data-dismiss="modal">No</button>
