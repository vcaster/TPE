...
class DeleteTimeSheet extends Component {
    ...
    submitForm = (event) => {
        ...
        if(formIsValid){
            ...
            this.props.dispatch(updateTimeSheet(dataToSubmit)).then(response =>{
                this.props.dispatch(adLog(this.props.user.userData._id,"Deleted Time Sheet",dataToSubmit,"/time_sheet_view/"+dataToSubmit._id,'delete')).then(response =>{
...
export default connect(mapStateToProps)(DeleteTimeSheet);