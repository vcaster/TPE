...
class EditMessage extends Component {
    ...
    success = () => {
        if (this.state.formSuccess){
            MySwal.fire({
                icon: 'success',
                title: 'Edited Message, You will be redirected shortly.'
              })
        }
        ...
        if(formIsValid){
            ...
            this.props.dispatch(updateMessage(dataToSubmit)).then(response =>{
                if(response.payload.success){
                    this.props.dispatch(adLog(this.props.user.userData._id,"Edited a Message",dataToSubmit,"/message_edit/"+dataToSubmit._id,"edit")).then(response =>{});
                    this.setState({
                        formError: false,
                        formSuccess: true
                    });
