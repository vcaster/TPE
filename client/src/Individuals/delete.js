...
import { clearForm, updateIndiv, getIndivId } from '../actions/user_actions';
...
class EditUser extends Component {
    ...
    success = () => {
        if (this.state.formSuccess){
            MySwal.fire({
                icon: 'success',
                title: 'Individual Successfully Deleted, You will be redirected shortly.'
              })
        }
    ...
    submitForm = (event) => {
        ...
        if(formIsValid){
            ...
            this.props.dispatch(updateIndiv(dataToSubmit)).then(response =>{
                this.props.dispatch(adLog(this.props.user.userData._id,"Deleted an Individual",dataToSubmit,"/individual_view/"+dataToSubmit._id,'delete')).then(response =>{
