...
textarea:hover, textarea:focus, #items td.total-value textarea:hover, #items td.total-value textarea:focus, .delete:hover { background-color:#EEFF88; }
	...
	<textarea style="display: block; margin-left: auto; margin-right: auto; width: 100%; text-align: center; padding: 20px 0" >${comp_info}</textarea>
		<textarea id="header2">HOUSE MEETING</textarea>
		<div id="identity">
		...
		<table id="meta3">
			...
			<tbody><tr>
               <td colspan="3" class="meta-head3">IN ATTENDANCE</td>
		  </tr>
		</tbody>

		<tbody><tr>
		       <td colspan="" class="meta-head3">INDIVIDUAL(S)</td>
               <td colspan="2" class="meta-head3">STAFF</td>
		  </tr>
		  
		  <tr class="item-row">
		      <td ><textarea style="width:100%;">${individual}</textarea></td>
		      <td colspan="3"><textarea style="width:100%;">${staff}</textarea></td>
		  </tr>
		  		
		</tbody>
		<tbody><tr>
		      <td colspan="2" class="meta-head3">MEETING NOTES</td>
		  </tr>
		  
		  <tr class="item-row">		  	
		      <td colspan="3"><textarea style="width: 100%; height: 300px; float:left;">${meetingnotes}</textarea></td>
		  </tr>
		 ...
		 <table id="meta3">
                <tbody><tr>
                    ...
                    <td><textarea id="date">${full}</textarea></td>
                </tr>
                <tr>
                    <td class="meta-head3">INDIVIDUAL SIGNATURE</td>
                    <td><img style="background-size: 200px 50px; width: 200px; height: 50px; background-color: white;" src="${indivsignimg1}" alt="signature"></td>
                    <td class="meta-head3">DATE</td>
                    <td><textarea id="date">${full}</textarea></td>
                </tr>
                ...
                <tr>
                    <td class="meta-head3">INDIVIDUAL SIGNATURE</td>
                    <td><img style="background-size: 200px 50px; width: 200px; height: 50px; background-color: white;" src="${indivsignimg2}" alt="signature"></td>
                    <td class="meta-head3">DATE</td>
                    <td><textarea id="date">${full}</textarea></td>
                </tr>
                <tr>
                    <td class="meta-head3">INDIVIDUAL SIGNATURE</td>
                    <td><img style="background-size: 200px 50px; width: 200px; height: 50px; background-color: white;" src="${indivsignimg3}" alt="signature"></td>
                    <td class="meta-head3">DATE</td>
                    <td><textarea id="date">${full}</textarea></td>
                </tr>
            ...
            <table id="meta3">
                <tbody><tr>
                    <td class="meta-head3">RESIDENTIAL SUPERVISOR SIGNATURE</td>
                ...
                <tr>
                    <td class="meta-head3">PROGRAM MANAGER SIGNATURE</td>
                    <td><img style="background-size: 200px 50px; width: 200px; height: 50px; background-color: white;" src="${managersignimg}" alt="signature"></td>
                    <td class="meta-head3">DATE</td>
                    <td><textarea id="date">${full}</textarea></td>
                </tr>
